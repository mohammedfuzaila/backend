...
# Only seed if the database is completely empty to prevent overwriting user changes
if Project.objects.exists():
    print("Database already contains data. Skipping seed to preserve user changes.")
else:
    # 1. Projects
    projects = [
